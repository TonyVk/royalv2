...
Config.Languages = {
  ['en'] = {
        ['emotes'] = 'Animacije',
        ['danceemotes'] = "🕺 Plesne animacije",
        ['propemotes'] = "📦 Animacije s objektima",
        ['favoriteemotes'] = "🌟 Favoriti",
        ['favoriteinfo'] = "Izaberite jednu animaciju da ju postavite kao favorita.",
        ['rfavorite'] = "Resetirajte favorite",
        ['prop2info'] = "❓ Animacije s objektima su na dnu",
        ['set'] = "Postavi (",
        ['setboundemote'] = ") kao tvoju vezanu animaciju?",
        ['newsetemote'] = "~w~ je sada tvoja vezana animacija, pritisni ~g~CapsLock~w~ da ju koristis.",
        ['cancelemote'] = "Prekini animaciju",
        ['cancelemoteinfo'] = "~r~X~w~ prekida trenutnu animaciju",
        ['walkingstyles'] = "Stilovi hodanja",
        ['resetdef'] = "Vrati na tvornicke",
        ['normalreset'] = "Normalan (Resetiranje)",
        ['moods'] = "Raspolozenja",
        ['infoupdate'] = "Informacije",
        ['infoupdateav'] = "Informacije (Update dostupan)",
        ['infoupdateavtext'] = "Dostupan je updaate, skinite zadnju verziju sa ~y~https://github.com/andristum/dpemotes~w~",
        ['suggestions'] = "Prijedlozi?",
        ['suggestionsinfo'] = "'dullpear_dev' na FiveM forumu! ✉️",
        ['notvaliddance'] = "nije valjan ples.",
        ['notvalidemote'] = "nije valjana animacija.",
        ['nocancel'] = "Nema animacije za prekinuti.",
        ['maleonly'] = "Ova animacija je samo za muskog lika!",
        ['emotemenucmd'] = "Upisite /emotemetu za menu sa animacijama.",
        ['shareemotes'] = "👫 Dijeljene animacije",
        ['shareemotesinfo'] = "Pozovite osobu blizu sebe da odradite animaciju zajedno",
        ['sharedanceemotes'] = "🕺 Dijeljeni plesovi",
        ['notvalidsharedemote'] = "nije valjana dijeljena animacija.",
        ['sentrequestto'] = "Poslali ste upit ~y~",
        ['nobodyclose'] = "Nitko nije ~r~blizu~w~.",
        ['doyouwanna'] = "~y~U~w~ da prihvatite, ~r~L~w~ da odbijete (~g~",
        ['refuseemote'] = "Animacija odbijena.",
        ['makenearby'] = "igrac do vas pokrene animaciju",
        ['camera'] = "Pritisnite ~y~G~w~ da koristite blic na kameri.",
        ['makeitrain'] = "Pritisnite ~y~G~w~ da krente bacat novac.",
        ['pee'] = "Drzite ~y~G~w~ da pisate.",
        ['spraychamp'] = "Drzite ~y~G~w~ da prosipate sampanjac",
        ['bound'] = "Povezano ",
        ['to'] = "na",
        ['currentlyboundemotes'] = " Trenutno vezane animacije:",
        ['notvalidkey'] = "nije vazeci kljuc.",
        ['keybinds'] = "🔢 Keybindovi",
