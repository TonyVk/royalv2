...
RegisterNetEvent('bind:RegisterKey')
AddEventHandler('bind:RegisterKey', function(layout, keyname, onpress, onrelease)
	print(type(onpress))
	RegisterKey(layout, keyname, onpress, onrelease)
end)
