...
TriggerEvent('esx_phone:registerNumber', 'fbi', _U('alert_police'), true, true)
TriggerEvent('esx_society:registerSociety', 'fbi', 'Vojna Policija', 'society_fbi', 'society_fbi', 'society_fbi', {type = 'public'})
