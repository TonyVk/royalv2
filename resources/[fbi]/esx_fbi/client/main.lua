  ...
  if Config.EnableArmoryManagement then
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('esx_sipa:giveWeapon', weapon,  1000)
      end,
      function(data, menu)
			...
			'default', GetCurrentResourceName(), 'citizen_interaction',
			{
				...
				if closestPlayer ~= -1 and closestDistance <= 3.0 then
					...
					elseif action == 'handcuff' then
						TriggerServerEvent('esx_sipa:handcuff', GetPlayerServerId(closestPlayer))
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil then
          ...
          TriggerServerEvent('esx_sipa:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if Config.EnablePlayerManagement then
          TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_sipa', _U('fine_total', label), amount)
        else
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_sipa:getVehicleInfos', function(infos)
  ...
  ESX.TriggerServerCallback('esx_sipa:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_sipa:buy', function(hasEnoughMoney)
...
AddEventHandler('esx_sipa:handcuff', function()
...
AddEventHandler('esx_sipa:drag', function(cop)
...
AddEventHandler('esx_sipa:OutVehicle', function(t)
