Config = {
	Language = "hr",					-- You can change the language here. I translated some with a tool online so they might not be 100% accurate. Let me know!
	...
	GUI = {
		...
		Key = GetKey("F11"), 				-- Change the GUI key here.
