...
RegisterServerEvent('esx_shelby:ZaveziGa')
AddEventHandler('esx_shelby:ZaveziGa', function(target)
  TriggerClientEvent('esx_shelby:ZaveziMe', target)
end)

RegisterServerEvent('esx_shelby:VuciGa')
AddEventHandler('esx_shelby:VuciGa', function(target)
  local _source = source
  TriggerClientEvent('esx_shelby:VuciMe', target, _source)
end)

RegisterServerEvent('esx_shelby:StaviUVozilo')
AddEventHandler('esx_shelby:StaviUVozilo', function(target)
  TriggerClientEvent('esx_shelby:StaviGa', target)
end)

RegisterServerEvent('esx_shelby:IzvuciIzVozila')
AddEventHandler('esx_shelby:IzvuciIzVozila', function(target)
    TriggerClientEvent('esx_shelby:IzvuciGa', target)
end)
