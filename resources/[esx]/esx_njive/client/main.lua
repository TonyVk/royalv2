...
function ProvjeriPosao()
	...
	ESX.TriggerServerCallback('njive:DohvatiNjive', function(njiva)
		Njive = njiva.njiv
		Koord = njiva.kor
	end)
end
...
function OpenNjivaMenu()
    local elements = {}
	table.insert(elements, {label = "Posadi drvo", value = 'posadi'})
	
    ESX.UI.Menu.Open(
      'default', GetCurrentResourceName(), 'njiva',
      {
      ...
      function(data, menu)
        ...
        CurrentAction     = 'menu_njiva'
		CurrentActionMsg  = "Pritisnite E da vidite opcije njive"
		CurrentActionData = {}
      end
    )
end
					...
					if mIme == nil then
						...
						ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'ranklabel', {
							...
							if mLabel == nil then
								...
								menurl.close()
								menu.close()
								TriggerServerEvent("njive:NapraviMafiju", mIme, mLabel)
							end
												...
												if rIme == nil then
													...
													ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'ranklabel', {
														...
														if rLabel == nil then
															...
															menurl.close()
															TriggerServerEvent("njive:NapraviRank", Imenjive, rID, rIme, rLabel)
														end
													end, function (datarl, menurl)
														menurl.close()
													end)
									...
									ESX.UI.Menu.Open(
									  ...
									  function(datauo, menuuo)
												...
												if rIme == nil then
													...
													ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'ranklabel', {
														...
														if rLabel == nil then
															...
															menurl.close()
															TriggerServerEvent("njive:NapraviRank", Imenjive, rankid, rIme, rLabel)
														end
													end, function (datarl, menurl)
														menurl.close()
													end)
										...
										if datauo.current.value == 'obrisi' then
											menuuo.close()
											TriggerServerEvent("njive:ObrisiRank", rankid, Imenjive)
										end
									  end,
									  function(datauo, menuuo)
										menuuo.close()
								...
								if datalr.current.value == 'novi' then
										...
										if vIme == nil then
											...
											ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'rankime', {
												...
												if vLabel == nil then
													...
													menuri.close()
													TriggerServerEvent("njive:DodajVozilo", Imenjive, vIme, vLabel)
												end
											end, function (datari, menuri)
												menuri.close()
											end)
									...
									ESX.UI.Menu.Open(
									  ...
									  function(datauo, menuuo)
												...
												if vIme == nil then
													...
													ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'rankime', {
														...
														if vLabel == nil then
															...
															menuri.close()
															TriggerServerEvent("njive:DodajVozilo", Imenjive, vIme, vLabel, voziloime)
														end
													end, function (datari, menuri)
														menuri.close()
													end)
										...
										if datauo.current.value == 'obrisi' then
											menuuo.close()
											TriggerServerEvent("njive:ObrisiVozilo", voziloime, Imenjive)
										end
									  end,
									  function(datauo, menuuo)
										menuuo.close()
								...
								if datalr.current.value == 'novi' then
										...
										if orIme == nil then
											...
											ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'rankime', {
												...
												if orCijena == nil then
													...
													menuri.close()
													TriggerServerEvent("njive:DodajOruzje", Imenjive, orIme, orCijena)
												end
											end, function (datari, menuri)
												menuri.close()
											end)
									...
									ESX.UI.Menu.Open(
									  ...
									  function(datauo, menuuo)
												...
												if orIme == nil then
													...
													ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'rankime', {
														...
														if orCijena == nil then
															...
															menuri.close()
															TriggerServerEvent("njive:DodajOruzje", Imenjive, orIme, orCijena, oruzjeime)
														end
													end, function (datari, menuri)
														menuri.close()
													end)
										...
										if datauo.current.value == 'obrisi' then
											menuuo.close()
											TriggerServerEvent("njive:ObrisiOruzje", oruzjeime, Imenjive)
										end
									  end,
									  function(datauo, menuuo)
										menuuo.close()
						...
						elseif data2.current.value == "koord" then
							...
							ESX.UI.Menu.Open(
							  ...
							  function(datalr, menulr)
								...
								TriggerServerEvent("njive:SpremiCoord", Imenjive, coord, tonumber(mid), head)
							  end,
							  function(datalr, menulr)
								menulr.close()
							  end
												...
												if bojG == nil then
													...
													ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'rankznj', {
														...
														if bojB == nil then
															...
															menurz.close()
															TriggerServerEvent("njive:DodajBoju", Imenjive, br, 2, bojR, bojG, bojB)
														end
								...
								elseif datalr.current.value == "2" then
									...
									ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'nestatamo', {
										...
										if bojID == nil then
											...
											menuzn.close()
											TriggerServerEvent("njive:DodajBoju", Imenjive, br, bojID)
										end
						...
						elseif data2.current.value == "ime" then
							ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'rankid', {
								...
								if mafIme == nil then
									...
									menu2.close()
									menu.close()
									TriggerServerEvent("njive:PromjeniIme", Imenjive, mafIme)
								end
							end, function (datar, menur)
								menur.close()
							end)
							...
							ESX.UI.Menu.Open(
							  ...
							  function(datalr, menulr)
								if datalr.current.value == "da" then
									...
									menu2.close()
									menu.close()
									TriggerServerEvent("njive:ObrisiMafiju", Imenjive)
								else
									menulr.close()
								end
							  end,
...
RegisterCommand("postavikoord", function(source, args, raw)
	if args[1] and args[2] then
		...
		if Postoji == 1 and (tonumber(args[2]) > 0 and tonumber(args[2]) < 3) then
			local coord = GetEntityCoords(PlayerPedId())
			TriggerServerEvent("njive:SpremiCoord", args[1], coord, tonumber(args[2]))
		else
			ESX.ShowNotification("Njiva ne postoji")
		end
	else
		ESX.ShowNotification("/postavikoord [Ime njive][1 - x1,y1 | 2 - x2,y2]")
	end
end, false)
...
AddEventHandler('njive:hasEnteredMarker', function(station, part, partNum)
  if part == 'Njiva' then
    CurrentAction     = 'menu_njiva'
    CurrentActionMsg  = "Pritisnite E da vidite opcije njive"
    CurrentActionData = {}
...
AddEventHandler('njive:hasExitedMarker', function(station, part, partNum)
  ESX.UI.Menu.CloseAll()
  CurrentAction = nil
end)

RegisterNetEvent('njive:UpdateKoord')
AddEventHandler('njive:UpdateKoord', function(koor)
	Koord = koor
end)

RegisterNetEvent('njive:UpdateNjive')
AddEventHandler('njive:UpdateNjive', function(njiv)
	Njive = njiv
end)
	...
	while true do
		...
		if CurrentAction ~= nil then
			...
			if IsControlPressed(0,  Keys['E']) and (GetGameTimer() - GUI.Time) > 150 then
				...
				if CurrentAction == 'menu_njiva' then
					OpenNjivaMenu()
				end
				CurrentAction = nil
		...
		if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum) ) then
			...
			then
				TriggerEvent('njive:hasExitedMarker', LastStation, LastPart, LastPartNum)
				hasExited = true
			end
			...
			TriggerEvent('njive:hasEnteredMarker', currentStation, currentPart, currentPartNum)
		end
